...
l3-firewall's OPA Rego policies cover **17 attack categories** with **301 Go tests** and **76 Rego tests** plus **28 demo tests** across 15 internal packages and 12 standalone demos. All packages are **terminally hardened** — red-team rounds 17–35 confirmed zero new vulnerabilities across all 5 target packages (syncer, l2filter, persist, capture, threatintel) and their integration points.
