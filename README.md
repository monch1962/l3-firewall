...
### Verified Test Coverage (414 Go+Rego tests)
...
| `cmd/server` | 5 | os.ReadFile FIFO block root cause, readPolicyFile FIFO rejection, oversized policy file rejection, regular policy file regression, bounded-read regression |
